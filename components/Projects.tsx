...
const PROJECTS: Project[] = [
  ...
  {
    name: "AfterText",
    tagline: "Chat'ini AI'ya ver, gerçeği öğren",
    description: "Romantik konuşmalarını yapıştır, acı gerçeği öğren. Ghost riski, ilgi skoru, kim daha çok seviyor — hepsi savage bir şekilde analiz ediliyor. Eğlence amaçlı.",
    tags: ["iOS", "AI", "Flutter", "Eğlence"],
